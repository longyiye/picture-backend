...
import com.yiye.infrastructure.annotation.AuthCheck;
import com.yiye.infrastructure.api.aliyunai.AliYunAiApi;
import com.yiye.infrastructure.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.yiye.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.yiye.infrastructure.api.imagesearch.ImageSearchApiFacade;
import com.yiye.infrastructure.api.imagesearch.model.ImageSearchResult;
import com.yiye.infrastructure.common.BaseResponse;
import com.yiye.infrastructure.common.DeleteRequest;
import com.yiye.infrastructure.common.ResultUtils;
import com.yiye.domain.user.constant.UserConstant;
...
import com.yiye.interfaces.assembler.PictureAssembler;
import com.yiye.interfaces.dto.picture.*;
import com.yiye.shared.auth.SpaceUserAuthManager;
import com.yiye.shared.auth.StpKit;
import com.yiye.shared.auth.annotation.SaSpaceCheckPermission;
import com.yiye.shared.auth.model.SpaceUserPermissionConstant;
...
import com.yiye.domain.picture.valueobject.PictureReviewStatusEnum;
import com.yiye.interfaces.vo.picture.PictureTagCategory;
import com.yiye.interfaces.vo.picture.PictureVO;
import com.yiye.application.service.PictureApplicationService;
import com.yiye.application.service.SpaceApplicationService;
...
public class PictureController {
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("yiyecture:listPictureVOByPage:%s", hashKey);
        // 1. 先从本地缓存中查询
