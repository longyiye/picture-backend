...
import com.yiye.api.aliyunai.model.GetOutPaintingTaskResponse;
...
import com.yiye.manager.auth.annotation.SaSpaceCheckPermission;
import com.yiye.manager.auth.model.SpaceUserPermissionConstant;
import com.yiye.model.dto.picture.*;
...
import com.yiye.model.vo.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("picture_backend:listPictureVOByPageWithCache:%s", hashKey);
        // 1. 先从本地缓存中查询
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList("热门", "搞笑", "生活", "艺术", "风景", "创意", "小西瓜");
        List<String> categoryList = Arrays.asList("素材", "电商", "科技", "媒体", "头像", "表情", "挚爱");
